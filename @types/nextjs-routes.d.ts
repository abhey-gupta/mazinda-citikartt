...
declare module "nextjs-routes" {
  ...
  export type Route =
    | StaticRoute<"/admin/addvendor">
    | StaticRoute<"/admin/login">
    | StaticRoute<"/admin">
    | StaticRoute<"/admin/vendordetails">
    | StaticRoute<"/auth/login">
    | StaticRoute<"/auth/signup">
    | DynamicRoute<"/order/[_id]/checkout/[order_id]", { "_id": string; "order_id": string }>
    | DynamicRoute<"/order/[_id]/checkout", { "_id": string }>
    | DynamicRoute<"/order/[_id]", { "_id": string }>
    | StaticRoute<"/">
    | StaticRoute<"/vendor/addproduct">
    | StaticRoute<"/vendor/auth/login">
    | StaticRoute<"/vendor">;
